...
developmental disability - and, per the current brief, that every person
shown is clearly an adult (ASG serves NJ DDD adults 21+ only; no child may
...
## assets/img/pfcp-adult-boxing.webp
- Source: https://www.pexels.com/photo/woman-doing-boxing-4058375/
- Photographer: Cliff Booth
- License: Pexels License (free for commercial use, no attribution required)
- Used in: "Who qualifies?" section
- Depicts: an adult woman with Down syndrome training with an adult coach in
  a gym - an independence/community context, a different person and
  photographer than every other photo on the page.
